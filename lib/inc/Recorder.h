...
namespace sairedis
{
    class Recorder
    {
        ...
        public: // SAI quad API
             ...
             *
             * NOTE: recordCreate should log (obejct_type, switch_id,
             * attr_count, attr_list) which we want to create new object id.
             * We ommit object id since we assume that object id was already
             ...
             * calling SAI create APIby using VirtualObjectIdManager.  That's
